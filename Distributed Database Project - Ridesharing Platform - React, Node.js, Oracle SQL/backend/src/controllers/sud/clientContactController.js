const ClientContactSud = require("../../models/sud/ClientContactSud");

exports.createClientContact = async (req, res) => {
  try {
    const clientcontact = await ClientContactSud.create(req.body);
...
exports.getAllClientContact = async (req, res) => {
  try {
    const clientcontact = await ClientContactSud.findAll();
...
exports.getClientContactById = async (req, res) => {
  try {
    const clientcontact = await ClientContactSud.findByPk(req.params.id);
