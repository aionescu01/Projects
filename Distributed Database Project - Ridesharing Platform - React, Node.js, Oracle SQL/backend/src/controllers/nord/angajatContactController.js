const AngajatContactNord = require("../../models/nord/AngajatContactNord");

exports.createAngajatContact = async (req, res) => {
  try {
    const angajatcontact = await AngajatContactNord.create(req.body);
...
exports.getAllAngajatContact = async (req, res) => {
  try {
    const angajatcontact = await AngajatContactNord.findAll();
...
exports.getAngajatContactById = async (req, res) => {
  try {
    const angajatcontact = await AngajatContactNord.findByPk(req.params.id);
