...
const { createDetaliiCursaCentral, getAllDetaliiCurseCentral, getDetaliiCursaCentralById, updateDetaliiCursaCentral, deleteDetaliiCursaCentral } = require("../../controllers/central/detaliiCursaCentralController");

/**
 * @swagger
 * tags:
 *   name: CENTRAL - DetaliiCursa
 *   description: API pentru gestionarea detaliilor curselor
 */

/**
 * @swagger
 * /api/central/detaliiCursaCentral:
 *   post:
 *     summary: Creează detalii cursă
 *     description: Adaugă un nou detaliu al unei curse în baza de date.
 *     tags: [CENTRAL - DetaliiCursa]
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 */
router.post("/", createDetaliiCursaCentral);
 ...
 */
router.get("/", getAllDetaliiCurseCentral);

/**
 * @swagger
 * /api/central/detaliiCursaCentral/{id}:
 *   get:
 ...
 */
router.get("/:id", getDetaliiCursaCentralById);
 ...
 */
router.put("/:id", updateDetaliiCursaCentral);
 ...
 */
router.delete("/:id", deleteDetaliiCursaCentral);
