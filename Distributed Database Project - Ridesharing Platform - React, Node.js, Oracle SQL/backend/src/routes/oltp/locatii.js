...
const { createLocatii, getAllLocatii, getLocatiiById, updateLocatii, deleteLocatii } = require("../../controllers/oltp/locatiiController");
 ...
 */
router.delete("/:id", deleteLocatii);
