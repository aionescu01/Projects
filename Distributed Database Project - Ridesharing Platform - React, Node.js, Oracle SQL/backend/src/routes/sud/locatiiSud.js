...
const { createLocatiiSud, getAllLocatiiSud, getLocatiiSudById, updateLocatiiSud, deleteLocatiiSud } = require("../../controllers/sud/locatiiSudController");
 ...
 */
router.get("/", getAllLocatiiSud);

/**
 * @swagger
 * /api/sud/locatiiSud/{id}:
 *   get:
 ...
 */
router.get("/:id", getLocatiiSudById);
 ...
 */
router.put("/:id", updateLocatiiSud);
 ...
 */
router.delete("/:id", deleteLocatiiSud);
