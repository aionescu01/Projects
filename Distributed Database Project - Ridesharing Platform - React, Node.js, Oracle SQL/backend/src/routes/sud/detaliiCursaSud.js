...
const { createDetaliiCursaSud, getAllDetaliiCurseSud, getDetaliiCursaSudById, updateDetaliiCursaSud, deleteDetaliiCursaSud } = require("../../controllers/sud/detaliiCursaSudController");

/**
 * @swagger
 * tags:
 *   name: SUD - DetaliiCursa
 *   description: API pentru gestionarea detaliilor curselor
 */

/**
 * @swagger
 * /api/sud/detaliiCursaSud:
 *   post:
 *     summary: Creează detalii cursă
 *     description: Adaugă un nou detaliu al unei curse în baza de date.
 *     tags: [SUD - DetaliiCursa]
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 */
router.post("/", createDetaliiCursaSud);
 ...
 */
router.get("/", getAllDetaliiCurseSud);

/**
 * @swagger
 * /api/sud/detaliiCursaSud/{id}:
 *   get:
 ...
 */
router.get("/:id", getDetaliiCursaSudById);
 ...
 */
router.put("/:id", updateDetaliiCursaSud);
 ...
 */
router.delete("/:id", deleteDetaliiCursaSud);
