...
mlp_classifier_model = MLPClassifier(hidden_layer_sizes=(100, 100),
                                     activation='relu', solver='adam', alpha=0.0001, batch_size=64,
...
mlp_classifier_model.fit(d2_train_dataset, train_labels)
# dam predict in functie de ce a fost antrenat
test_predictions = mlp_classifier_model.predict(d2_validation_dataset)
