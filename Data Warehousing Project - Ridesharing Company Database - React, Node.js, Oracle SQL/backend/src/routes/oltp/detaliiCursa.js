...
const { createDetaliiCursa, getAllDetaliiCurse, getDetaliiCursaById, updateDetaliiCursa, deleteDetaliiCursa } = require("../../controllers/oltp/detaliiCursaController");

/**
 * @swagger
 * tags:
 *   name: OLTP - DetaliiCursa
 *   description: API pentru gestionarea detaliilor curselor
 */

/**
 * @swagger
 * /api/oltp/detaliiCursa:
 *   post:
 *     summary: Creează detalii cursă
 *     description: Adaugă un nou detaliu al unei curse în baza de date.
 *     tags: [OLTP - DetaliiCursa]
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 */
router.post("/", createDetaliiCursa);
 ...
 */
router.get("/", getAllDetaliiCurse);

/**
 * @swagger
 * /api/oltp/detaliiCursa/{id}:
 *   get:
 ...
 */
router.get("/:id", getDetaliiCursaById);
 ...
 */
router.put("/:id", updateDetaliiCursa);
 ...
 */
router.delete("/:id", deleteDetaliiCursa);
