...
folosirea metodelor getComputedStyle si stopPropagation cu un sens relevant;                        //tab 2 si 3 chrome
validarea datelor dintr-un formular folosind expresii regulate;                                     //tab 4 chrome poate la acreditari presa
setTimeout, setInterval;                                                                            //adaugat timer aici pentru ghicit cu setInterval??
folosirea localStorage (sa se pastreze in localStorage o colectie de elemente);                     //joc ca ala cu hello dar cu goool
schimbarea aleatoare a valorilor unor proprietati (de exemplu: culoare, dimensiuni, pozitii);          //se schimba numarul aici?
*/